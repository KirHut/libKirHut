...
# define KH_COMPILER_DISPLAY_STRING
# define KH_CUDA_ENABLED
# define KH_EXPORT
# define KH_NO_EXPORT
 ...
 * multiple empty base classes, this is a necessity. Because Clang devs love to shoot themselves in the foot, this is
 * also necessary when using Clang-cl to compile this library to the MSVC ABI.
 *
 * This is always defined after including this header.
 */
#if defined(_MSC_VER)
...
enum class WhyInvalid
{
    ...
    IllegalOverflow      = 25, //!< 25 - Some value that is not allowed to overflow did or will.
    CausesUndefined      = 26, //!< 26 - Performing this action would cause undefined behavior in C++.
